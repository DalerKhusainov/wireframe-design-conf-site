function SubscribeForUpdates() {
  return (
    <section className="relative mb-20 border-b border-b-slate/10">
      ...
      <p className="z-50 text-lg font-medium mobile:text-xl text-slate font-inter mb-11">
        Sign up to our newsletter to get the latest information Wireframe Design
        Conf.
      </p>
      <div className="max-w-[500px] z-50 mb-20 gap-6 flex flex-col items-center mobile:flex-row mobile:justify-between">
        <input
          type="text"
        ...
        />
        <button className="px-6 py-2 z-50 text-[16px] mobile:w-auto w-full text-white transition-colors ease-in-out rounded font-roboto bg-purple hover:bg-midnight">
          Subscribe
        </button>
      </div>
    </section>
